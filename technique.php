  ...
  <body>
    ...
    <div class="wrapper">
        ...
        <div class="article-contain">
            ...
            <p>Toujours dans le but de réduire l’impact environnemental et minimiser la quantité de données transférées lors des chargements de page, nous avons optimisé notre code HTML et créé des variables dans notre CSS afin d’éviter les répétitions. De plus, le code a été minimisé avec un outil qui permet de supprimer tous les caractères inutiles. Pour des raisons de maintenabilité et de lisibilité, nous avons garder une copie du code non minifié, tandis que la version minimisée est utilisée lors du déploiement.
            </p>
            <h3>Audit du site</h3>
